...
public class SmileApplication {
    ...
    public static ConfigurableApplicationContext run(Class primarySources, String[] args) {
        ...
        AnnotationConfigApplicationContext smileApplicationContext = new AnnotationConfigApplicationContext(primarySources);
        /**
        ...
        simpleApplicationContextInitializer.initialize(smileApplicationContext);
        return null;
    }
