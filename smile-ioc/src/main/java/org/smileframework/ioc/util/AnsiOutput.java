...
public abstract class AnsiOutput {
    ...
    private static boolean detectIfAnsiCapable() {
        try {
            return Boolean.FALSE.equals(consoleAvailable)?false:(consoleAvailable == null && System.console() == null?false:!OPERATING_SYSTEM_NAME.contains("win"));
